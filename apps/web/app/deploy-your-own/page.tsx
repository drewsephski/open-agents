...
const DEPLOY_TEMPLATE_URL = (() => {
  const params = new URLSearchParams([
    ["project-name", "launchstack"],
    ["repository-name", "launchstack"],
    ["repository-url", "https://github.com/drewsephski/open-agents"],
    ["demo-title", "Launchstack"],
    [
      "demo-description",
      "Cloud coding agents that work autonomously from code to launch.",
    ],
    ["demo-url", "https://launchstack.sh/"],
...
export const metadata: Metadata = {
  ...
  description:
    "Deploy your own copy of Launchstack to unlock the full template.",
};
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background px-6 py-24 text-foreground">
      <div className="flex max-w-xl flex-col items-center text-center">
        <p className="text-sm font-medium text-muted-foreground">Launchstack</p>
        <h1 className="mt-4 text-4xl font-semibold tracking-tight">
          Deploy your own
        </h1>
        <p className="mt-4 text-base leading-7 text-muted-foreground">
          This hosted demo has limited functionality. Deploy your own copy to
          unlock the full Launchstack template.
        </p>
