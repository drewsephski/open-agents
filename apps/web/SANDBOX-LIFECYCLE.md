...
Configured in `lib/sandbox/config.ts`. The Hobby-compatible profile is the safe default; set `OPEN_AGENTS_RESOURCE_PROFILE=standard` to opt into paid-plan limits.
